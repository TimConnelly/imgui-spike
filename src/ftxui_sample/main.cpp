...
// configuration step. It creates a namespace called `imgui_spike`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", imgui_spike::cmake::project_name, imgui_spike::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", imgui_spike::cmake::project_version);
      return EXIT_SUCCESS;
    }
